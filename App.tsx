                  ...
                  <div className="max-w-2xl mx-auto flex flex-col space-y-6">
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        <label htmlFor="productDescription" className="text-lg font-semibold text-stone-700">2. Product Details (for story)</label>
                        <VoiceInput onResult={(transcript) => setProductDescription(prev => prev ? `${prev} ${transcript}` : transcript)} />
                      </div>
                      <textarea
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        <label htmlFor="targetAudience" className="text-lg font-semibold text-stone-700">3. Target Audience</label>
                        <VoiceInput onResult={(transcript) => setTargetAudience(prev => prev ? `${prev} ${transcript}` : transcript)} />
                      </div>
                      <input
                        id="targetAudience"
                        type="text"
                    ...
                    {shouldGenerateImages && (
                      <div className="transition-all duration-500">
                        <div className="flex items-center justify-between mb-2">
                          <label htmlFor="aesthetic" className="text-lg font-semibold text-stone-700">5. Desired Photo Aesthetic / Vibe</label>
                          <VoiceInput onResult={(transcript) => setAesthetic(prev => prev ? `${prev} ${transcript}` : transcript)} />
                        </div>
                        <input
                          id="aesthetic"
                          type="text"
